...
namespace QLQCF.DAO
{
    public class DAO_Menu
    {
        ...
        public List<DTO_Menu> GetListMenuByTable(int id)
        {
            ...
            string query = "Select TenMon, SoLuong, DonGia, ThanhTien from XuatHDChiTiet join XuatHD on XuatHDChiTiet.SoHDX = XuatHD.SoHDX join Mon on XuatHDChiTiet.MaMon = Mon.MaMon where XuatHD.SoHDX = " +id;
